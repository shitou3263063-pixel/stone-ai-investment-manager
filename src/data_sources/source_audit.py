...
def _default_registry() -> dict[str, Any]:
    ...
    metrics = {
        ...
        "03033.HK": ("market", "price", "market_valuation", "finnhub", "yfinance", "2d"),
        "510300.SS": ("market", "price", "market_valuation", "finnhub", "yfinance", "2d"),
        "002558.SZ": ("market", "price", "market_valuation", "finnhub", "yfinance", "2d"),
        "513060.SS": ("market", "price", "market_valuation", "finnhub", "yfinance", "2d"),
        "513090.SS": ("market", "price", "market_valuation", "finnhub", "yfinance", "2d"),
